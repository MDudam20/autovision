                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                                <div class="footer-widget__about">
                                    <div class="footer-widget__about-logo">
                                        <a href="/"><img src="assets/images/autovision-about/Autovision (3).png"
                                                alt=""></a>
                                    </div>
                                    <p class="footer-widget__about-text">Since 2010, Autovision has been the leading trader of Automotive Spare parts for the OEM Segment of Premium Luxury Vehicles in India.</p>
                                ...
                                <div class="footer-widget__contact">
                                    ...
                                    <ul class="footer-widget__contact-list list-unstyled">
                                        <li>
                                            ...
                                            <p>Avantikabai Gokhale Street 20, Jagmohan Mansion, Ground Floor, Shop No.1, Avantikabai Gokhale Street Opera House, Mumbai - 4000004
                                            </p>
                                        </li>
                                        <li>
                                            <div class="icon">
                                            ...
                                            <p><a href="tel:+91 9930585115">+91 9930585115</a></p>
                                        </li>
                                        <li>
                                            <div class="icon">
                                                <span class="icon-call"></span>
                                            </div>
                                            <p><a href="tel:+91 9136675405">+91 9136675405</a></p>
                                        </li>
                                        <li>
                                            <div class="icon">
                                                <span class="icon-envelope"></span>
                                            </div>
                                            <p><a href="mailto:info.autovision@gmail.com">info.autovision@gmail.com</a></p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
