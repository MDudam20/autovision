...
<head>
    ...
    <title> About Us || Autovision </title>
    <!-- favicons Icons -->
                        ...
                        <div class="about-one__left wow slideInLeft" data-wow-delay="100ms" data-wow-duration="2500ms">
                            <div class="about-one__img-box">
                                <div class="about-one__img">
                                    <img src="assets/images/autovision-about/1.png" alt="">
                                </div>
                                ...
                                <div class="about-one__img-2">
                                    <img src="assets/images/autovision-about/2.png" alt="">
                                </div>
                    ...
                    <div class="col-xl-6">
                        <div class="about-one__right">
                            <div class="section-title text-left sec-title-animation animation-style1">
                                ...
                                <h2 class="section-title__title title-animation">Redefining Spare Parts Excellence Since 2010</h2>
                            </div>
                            <p class="about-one__text-1">Committed to providing our customers with<br> ultimate service.
                            </p>
                            <p class="about-one__text-2">Strategically located in India’s prime automobile spare part market, we provide seamless access to a wide range of trusted brands at competitive rates. With a strong focus on customer satisfaction, we ensure timely delivery, secure packaging, and tailored solutions for businesses and individual needs.</p>
                            <p class="about-one__text-2">As we expand into exports, we bring our legacy of trust, quality, and service to a global audience. At Autovision, every part we supply reflects our commitment to excellence and our promise to keep your vehicles running smoothly.</p>
                            
                            <div class="about-one__btn-box-and-call-box">
                                <div class="about-one__btn-box">
                                    <a href="about-us" class="about-one__btn thm-btn">Read More<span
